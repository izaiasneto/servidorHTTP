...
public class Resposta {
    ...
    public Resposta(String protocolo, int codigoResposta, String mensagem) {
    ...
    // pega o tamanho da resposta em bytes retorna o valor
    // em bytes do tamanho da resposta  do conteudo
     
    public String getTamanhoResposta() {
        return getConteudoResposta().length + "";
    }

    // converte o cabecalho em string e retorna o cabecalho em bytes
